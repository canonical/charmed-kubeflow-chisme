...
def generate_container_uid_map(metadata_yaml: dict, juju_user_id: int = 170):
    ...
    Example:
        ...
        ...     }
        ... }
        >>> generate_container_uid_map(metadata)
        {
...
def assert_security_context(
    ...
    containers_uid_map. It raises an AssertionError if any security context attribute
    ...
    Args:
        ...
        containers_uid_map (dict): A mapping of container names to their expected
    ...
    for key, value in containers_uid_map.get(container_name).items():
